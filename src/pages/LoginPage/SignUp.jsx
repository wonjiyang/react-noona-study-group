...
const SignUp = () => {
  ...
  const handleSignUp = (e) => {
    ...
    setModalMessage(
      `🎉 ${userName}님, MentorMe의 회원이 되신 것을 축하드립니다.`
    );
    setShowModal(true);
        ...
        <div className="white-background">
          ...
          <Form onSubmit={handleSignUp}>
            <FloatingLabel
              ...
              label={
                <>
                  <span style={{ fontSize: '0.7em' }}>아이디</span>
            ...
            <FloatingLabel
              ...
              label={
                <>
                  <span style={{ fontSize: '0.7em' }}>이메일</span>
                  <span className="required-star">*</span>
                </>
              }
              className="mb-2"
            ...
            <div>
              {email.length > 0 &&
                (!emailRegex.test(email) ? (
                  <div className="invalid-password-msg">
                    <small>
                      <FontAwesomeIcon icon={faXmark} /> 이메일 형식에 맞춰
                      입력해주세요.
                    </small>
                  </div>
                ) : null)}
            ...
            <div style={{ position: 'relative' }}>
              <FloatingLabel
                ...
                label={
                  <>
                    <span style={{ fontSize: '0.7em' }}>비밀번호</span>
                    <span className="required-star">*</span>
                  </>
                }
                className="mb-2"
            ...
            <FloatingLabel
              ...
              label={
                <>
                  <span style={{ fontSize: '0.7em' }}>비밀번호 재확인</span>
                  <span className="required-star">*</span>
                </>
              }
              className="mb-2"
            ...
            <div>
              {passwordCheck.length > 0 &&
                (password === passwordCheck ? (
                  ...
                  <div className="invalid-password-msg">
                    <small>
                      <FontAwesomeIcon icon={faXmark} /> 비밀번호가 일치하지
                      않습니다.
                    </small>{' '}
                                             
                  </div>
